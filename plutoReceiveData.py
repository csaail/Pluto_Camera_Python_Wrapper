...
def evaluateCommand(command):
    global roll, pitch, yaw, battery, rssi, accX, accY, accZ, gyroX, gyroY, gyroZ, magX, magY, magZ, alt, rcAUX1, rcAUX2, rcAUX3, rcAUX4, rcThrottle, rcPitch, rcYaw, rcRoll
...
def readFrame():
    ...
    if c_state == IDLE:
        ...
        # print((checksum & 0xFF) == (ord(c) & 0xFF))
...
def readFunction():
    while True:
        ...
        print(f'Battery={battery} RSSI={rssi}')

        print(f'Developer Mode={rcAUX2}')
